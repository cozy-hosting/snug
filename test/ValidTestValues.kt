...
class ValidTestValues {
    companion object {
        ...
        val containers = setOf(Container("Container1", image, portsWithoutName), Container("Container2", image, portsWithoutName))
        ...
        val publish = Publish(publishPortNumbers, publishDomains)
